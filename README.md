...
at det minimale antal af venner for en spiller skal være 2 eller 3 (Constants.num_initial_friends=3).
Hver spiller kan kun se sit eget ego-netværk og chatte med sine venner individuelt.
Spilleren kan så vælge rød eller blå, og man kan se graden af konsensus i i hele gruppen i
en progress-bar.
